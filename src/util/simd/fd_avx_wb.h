...
/* A wb_t is a vector where each 8-bit wbde lane holds an unsigned 8-bit
   uchareger (a "uchar").
...
// /* wb_ldif is an optimized equivalent to wb_notczero(c,wb_ldu(p)) (may
//    have different behavior if c is not a proper vector conditional).  It
//    is provided for symmetry wbth the wb_stif operation.  wb_stif stores
//    x(n) to p[n] if c(n) is true and leaves p[n] unchanged otherwbse.
//    Undefined behavior if c is not a proper vector conditional. */
// /* Sadly, no maskload_epi8 */
//
// #define wb_ldif(c,p)   _mm256_maskload_epi32( (p),(c))
// #define wb_stif(c,p,x) _mm256_maskstore_epi32((p),(c),(x))
//
...
//#define wb_mul(a,b) _mm256_mullo_epi32( (a), (b) ) /* [ a0 *b0     a1 *b1     ... a7 *b7     ] */
...
//#define wb_shr_variable(a,n)  _mm256_sra_epi32( (a), _mm_insert_epb64( _mm_setzero_sb128(), (n), 0 ) )
#define wb_shru_variable(a,n) wb_and( _mm256_srl_epi16( (a), _mm_insert_epi64( _mm_setzero_si128(), (n), 0 ) ), \
                                      wb_bcast( (uchar)(0xFFUL >> (n)) ) )

//#define wb_shl_vector(a,b)
//#define wb_shr_vector(a,b)
//#define wb_shru_vector(a,b)
...
#define wb_lnotnot(a)                                                  /* [ !!a0 !!a1 ... !!a31 ] */ \
  _mm256_xor_si256( _mm256_set1_epi32( -1 ), _mm256_cmpeq_epi8( (a), _mm256_setzero_si256() ) )
